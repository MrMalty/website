<template>
  <MainLayout>
    <div id="CheckoutPage" class="mt-4 max-w-[1200px] mx-auto px-2">
      <div class="md:flex gap-4 justify-between mx-auto w-full text-[#0E2167]">
        <div class="md:w-[65%]">
        ...
        <div class="md:w-[35%]">
          <div id="PlaceOrder" class="bg-[#CCDAE0] rounded-lg p-4">
            ...
            <div class="border-t border-[#0E2167]" />
          ...
          <form @submit.prevent="pay()">
            ...
            <button
              ...
              type="submit"
              class="mt-4 bg-gradient-to-r from-[#0E2167] to-[#23AAEF] w-full text-white text-12px font-semibold p-1.5 rounded-full"
          ...
          <div class="bg-[#CCDAE0] rounded-lg p-4 mt-4">

          ...
          <div id="PlaceOrder" class="bg-white rounded-lg p-4">
            ...
            <form @submit.prevent="pay()">
              <div
                ...
                id="card-element"
              />
              <p class="text-orange-700 text-center font-semibold">TEST MODE</p>
              <p
                id="card-error"
                role="alert"
              ...
              <button
                ...
                type="submit"
                class="mt-4 bg-gradient-to-r from-[#0E2167] to-[#23AAEF] w-full text-white text-[21px] font-semibold p-1.5 rounded-full"
...
const stripeInit = async () => {
  ...
  stripe = Stripe("pk_test_51QGqrDQd79UHJYCJmAIc482uMEjhcDujJbx60bxC2TxFpMY0Hmlaw4YN0NPsnaDMKRNHZh1zpb9pVAcCYXzsHJT200aqPUyrCd");

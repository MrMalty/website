  ...
  >
    ...
    <div class="mb-5">
      ...
      ><input
        ...
        name="email"
        required
        class="w-4xl px-4 py-3 border-2 placeholder:text-InputPrimary rounded-md outline-none focus:ring-4 border-InputBorder focus:border-InputBorderFocus ring-InputBorderRing"
      />
